export type GameSlug =
  ...
  | "critters-quest"
  | "brainrot-merge"
  | "merge-monster-battles"
  | "stupidella-horror-2"
  | "capitalist-bus-driver"
  | "the-third-piglets-tower"
  | "pocket-car-city"
  | "hockey-taka"
  | "dwerg"
  | "stickman-maze-run"
  ...
  | "catch-a-pet"
  | "battle-blast"
  | "annoying-teacher-punch-game"
  | "draft-wars"
  | "sushi-situation"
  | "find-it"
  | "lafufu-blind-box-dress-up"
  | "tens"
  | "a-small-world-cup-2"
  | "veggie-merge"
  | "spacebar-clicker"
