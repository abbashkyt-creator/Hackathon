...
const GAME_SOURCE = "tiptap-dan-the-man";
const PARENT_SOURCE = "tiptap-parent";

export function DanTheManGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/dan-the-man/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena dan-the-man-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena dan-the-man-game"
      src={gameUrl}
      title="Play dan-the-man"
