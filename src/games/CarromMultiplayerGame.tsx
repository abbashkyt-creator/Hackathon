...
const GAME_SOURCE = "tiptap-carrom-multiplayer";
const PARENT_SOURCE = "tiptap-parent";

export function CarromMultiplayerGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/carrom-multiplayer/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena carrom-multiplayer-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena carrom-multiplayer-game"
      src={gameUrl}
      title="Play carrom-multiplayer"
