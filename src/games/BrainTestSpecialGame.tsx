...
const GAME_SOURCE = "tiptap-brain-test-special";
const PARENT_SOURCE = "tiptap-parent";

export function BrainTestSpecialGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/brain-test-special/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena brain-test-special-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena brain-test-special-game"
      src={gameUrl}
      title="Play brain-test-special"
