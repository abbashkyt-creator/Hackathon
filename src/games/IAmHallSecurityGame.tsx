...
const GAME_SOURCE = "tiptap-i-am-hall-security";
const PARENT_SOURCE = "tiptap-parent";

export function IAmHallSecurityGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/i-am-hall-security/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena i-am-hall-security-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena i-am-hall-security-game"
      src={gameUrl}
      title="Play i-am-hall-security"
