...
const GAME_SOURCE = "tiptap-snake-vs-human";
const PARENT_SOURCE = "tiptap-parent";

export function SnakeVsHumanGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/snake-vs-human/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena snake-vs-human-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena snake-vs-human-game"
      src={gameUrl}
      title="Play snake-vs-human"
