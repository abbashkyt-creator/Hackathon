...
export function PingPongGoGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  if (!active) {
    return <div className="game-arena ping-pong-go-placeholder" aria-hidden="true" />;
  }

  return (
    <iframe
      ref={frameRef}
      className="game-arena ping-pong-go-game"
      src={gameUrl}
      title="Play Ping Pong Go"
