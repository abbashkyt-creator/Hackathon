...
const GAME_SOURCE = "tiptap-decor-life";
const PARENT_SOURCE = "tiptap-parent";

export function DecorLifeGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/decor-life/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena decor-life-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena decor-life-game"
      src={gameUrl}
      title="Play decor-life"
