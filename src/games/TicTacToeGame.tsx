...
const GAME_SOURCE = "tiptap-tic-tac-toe";
...
export function TicTacToeGame({
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/tic-tac-toe/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) {
    return <div className="game-arena tic-tac-toe-placeholder" aria-hidden="true" />;
  }

  return (
    <iframe
      ref={frameRef}
      className="game-arena tic-tac-toe-game"
      src={gameUrl}
