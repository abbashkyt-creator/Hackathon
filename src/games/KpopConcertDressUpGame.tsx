...
const GAME_SOURCE = "tiptap-kpop-concert-dress-up";
const PARENT_SOURCE = "tiptap-parent";

export function KpopConcertDressUpGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/kpop-concert-dress-up/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena kpop-concert-dress-up-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena kpop-concert-dress-up-game"
      src={gameUrl}
      title="Play kpop-concert-dress-up"
