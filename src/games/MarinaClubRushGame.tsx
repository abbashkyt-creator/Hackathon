...
const GAME_SOURCE = "tiptap-marina-club-rush";
const PARENT_SOURCE = "tiptap-parent";

export function MarinaClubRushGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/marina-club-rush/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena marina-club-rush-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena marina-club-rush-game"
      src={gameUrl}
      title="Play marina-club-rush"
