...
const GAME_SOURCE = "tiptap-scary-little-prankster";
const PARENT_SOURCE = "tiptap-parent";

export function ScaryLittlePranksterGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/scary-little-prankster/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena scary-little-prankster-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena scary-little-prankster-game"
      src={gameUrl}
      title="Play scary-little-prankster"
