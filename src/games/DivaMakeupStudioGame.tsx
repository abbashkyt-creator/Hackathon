...
const GAME_SOURCE = "tiptap-diva-makeup-studio";
const PARENT_SOURCE = "tiptap-parent";

export function DivaMakeupStudioGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/diva-makeup-studio/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena diva-makeup-studio-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena diva-makeup-studio-game"
      src={gameUrl}
      title="Play diva-makeup-studio"
