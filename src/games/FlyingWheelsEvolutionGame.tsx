...
const GAME_SOURCE = "tiptap-flying-wheels-evolution";
const PARENT_SOURCE = "tiptap-parent";

export function FlyingWheelsEvolutionGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/flying-wheels-evolution/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena flying-wheels-evolution-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena flying-wheels-evolution-game"
      src={gameUrl}
      title="Play flying-wheels-evolution"
