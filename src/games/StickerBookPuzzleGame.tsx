...
const GAME_SOURCE = "tiptap-sticker-book-puzzle";
const PARENT_SOURCE = "tiptap-parent";

export function StickerBookPuzzleGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/sticker-book-puzzle/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena sticker-book-puzzle-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena sticker-book-puzzle-game"
      src={gameUrl}
      title="Play sticker-book-puzzle"
