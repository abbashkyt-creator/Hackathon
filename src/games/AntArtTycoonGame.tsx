...
const GAME_SOURCE = "tiptap-ant-art-tycoon";
const PARENT_SOURCE = "tiptap-parent";

export function AntArtTycoonGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/ant-art-tycoon/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena ant-art-tycoon-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena ant-art-tycoon-game"
      src={gameUrl}
      title="Play ant-art-tycoon"
