...
const GAME_SOURCE = "tiptap-gas-station";
...
export function GasStationGame({
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/gas-station/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena gas-station-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena gas-station-game"
      src={gameUrl}
      title="Play gas-station"
