...
const GAME_SOURCE = "tiptap-diva-hair-salon";
const PARENT_SOURCE = "tiptap-parent";

export function DivaHairSalonGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/diva-hair-salon/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena diva-hair-salon-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena diva-hair-salon-game"
      src={gameUrl}
      title="Play diva-hair-salon"
