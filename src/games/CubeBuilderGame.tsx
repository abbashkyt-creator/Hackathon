...
const GAME_SOURCE = "tiptap-cube-builder";
...
export function CubeBuilderGame({
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/cube-builder/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena cube-builder-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena cube-builder-game"
      src={gameUrl}
      title="Play cube-builder"
