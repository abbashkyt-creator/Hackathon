...
const GAME_SOURCE = "tiptap-sandbox-of-elements";
const PARENT_SOURCE = "tiptap-parent";

export function SandboxOfElementsGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/sandbox-of-elements/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena sandbox-of-elements-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena sandbox-of-elements-game"
      src={gameUrl}
      title="Play sandbox-of-elements"
