...
const GAME_SOURCE = "tiptap-dasi-spa-manager";
const PARENT_SOURCE = "tiptap-parent";

export function DasiSpaManagerGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/dasi-spa-manager/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena dasi-spa-manager-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena dasi-spa-manager-game"
      src={gameUrl}
      title="Play dasi-spa-manager"
