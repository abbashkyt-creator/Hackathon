...
const GAME_SOURCE = "tiptap-build-your-island";
const PARENT_SOURCE = "tiptap-parent";

export function BuildYourIslandGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/build-your-island/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena build-your-island-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena build-your-island-game"
      src={gameUrl}
      title="Play build-your-island"
