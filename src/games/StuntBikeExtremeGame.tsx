...
const GAME_SOURCE = "tiptap-stunt-bike-extreme";
const PARENT_SOURCE = "tiptap-parent";

export function StuntBikeExtremeGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/stunt-bike-extreme/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena stunt-bike-extreme-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena stunt-bike-extreme-game"
      src={gameUrl}
      title="Play Stunt Bike Extreme - Poki"
