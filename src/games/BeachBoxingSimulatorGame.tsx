...
const GAME_SOURCE = "tiptap-beach-boxing-simulator";
const PARENT_SOURCE = "tiptap-parent";

export function BeachBoxingSimulatorGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/beach-boxing-simulator/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena beach-boxing-simulator-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena beach-boxing-simulator-game"
      src={gameUrl}
      title="Play beach-boxing-simulator"
