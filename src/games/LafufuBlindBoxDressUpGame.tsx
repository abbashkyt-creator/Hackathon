...
const GAME_SOURCE = "tiptap-lafufu-blind-box-dress-up";
const PARENT_SOURCE = "tiptap-parent";

export function LafufuBlindBoxDressUpGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/lafufu-blind-box-dress-up/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena lafufu-blind-box-dress-up-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena lafufu-blind-box-dress-up-game"
      src={gameUrl}
      title="Play lafufu-blind-box-dress-up"
