...
const GAME_SOURCE = "tiptap-slice-master";
...
export function SliceMasterGame({
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/slice-master/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) {
    return <div className="game-arena slice-master-placeholder" aria-hidden="true" />;
  }

  return (
    <iframe
      ref={frameRef}
      className="game-arena slice-master-game"
      src={gameUrl}
      title="Play Slice Master"
