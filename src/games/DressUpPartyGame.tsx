...
const GAME_SOURCE = "tiptap-dress-up-party";
const PARENT_SOURCE = "tiptap-parent";

export function DressUpPartyGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/dress-up-party/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena dress-up-party-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena dress-up-party-game"
      src={gameUrl}
      title="Play dress-up-party"
