...
const GAME_SOURCE = "tiptap-schools-out-the-great-escape";
const PARENT_SOURCE = "tiptap-parent";

export function SchoolsOutTheGreatEscapeGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/schools-out-the-great-escape/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena schools-out-the-great-escape-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena schools-out-the-great-escape-game"
      src={gameUrl}
      title="Play schools-out-the-great-escape"
