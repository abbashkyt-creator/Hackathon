...
const GAME_SOURCE = "tiptap-duel-of-chance";
const PARENT_SOURCE = "tiptap-parent";

export function DuelOfChanceGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/duel-of-chance/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena duel-of-chance-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena duel-of-chance-game"
      src={gameUrl}
      title="Play duel-of-chance"
