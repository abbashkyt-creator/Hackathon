...
const GAME_SOURCE = "tiptap-fight-and-loot";
const PARENT_SOURCE = "tiptap-parent";

export function FightAndLootGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/fight-and-loot/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena fight-and-loot-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena fight-and-loot-game"
      src={gameUrl}
      title="Play fight-and-loot"
