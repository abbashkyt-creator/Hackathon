...
const GAME_SOURCE = "tiptap-idle-lumber-inc";
const PARENT_SOURCE = "tiptap-parent";

export function IdleLumberIncGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/idle-lumber-inc/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena idle-lumber-inc-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena idle-lumber-inc-game"
      src={gameUrl}
      title="Play Idle Lumber Inc - Poki"
