...
const GAME_SOURCE = "tiptap-mad-skills-rallycross";
const PARENT_SOURCE = "tiptap-parent";

export function MadSkillsRallycrossGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/mad-skills-rallycross/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena mad-skills-rallycross-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena mad-skills-rallycross-game"
      src={gameUrl}
      title="Play mad-skills-rallycross"
