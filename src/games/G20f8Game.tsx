...
const GAME_SOURCE = "tiptap-20f8";
const PARENT_SOURCE = "tiptap-parent";

export function G20f8Game({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/20f8/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena 20f8-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena 20f8-game"
      src={gameUrl}
      title="Play 20f8"
