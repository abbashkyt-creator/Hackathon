...
const GAME_SOURCE = "tiptap-sort-the-court";
const PARENT_SOURCE = "tiptap-parent";

export function SortTheCourtGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/sort-the-court/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena sort-the-court-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena sort-the-court-game"
      src={gameUrl}
      title="Play sort-the-court"
