...
const GAME_SOURCE = "tiptap-stupidella-horror-2";
const PARENT_SOURCE = "tiptap-parent";

export function StupidellaHorror2Game({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/stupidella-horror-2/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena stupidella-horror-2-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena stupidella-horror-2-game"
      src={gameUrl}
      title="Play stupidella-horror-2"
