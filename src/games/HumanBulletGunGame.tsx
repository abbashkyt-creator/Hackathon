...
const GAME_SOURCE = "tiptap-human-bullet-gun";
const PARENT_SOURCE = "tiptap-parent";

export function HumanBulletGunGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/human-bullet-gun/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena human-bullet-gun-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena human-bullet-gun-game"
      src={gameUrl}
      title="Play human-bullet-gun"
