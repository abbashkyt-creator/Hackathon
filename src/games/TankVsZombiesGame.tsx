...
const GAME_SOURCE = "tiptap-tank-vs-zombies";
const PARENT_SOURCE = "tiptap-parent";

export function TankVsZombiesGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/tank-vs-zombies/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena tank-vs-zombies-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena tank-vs-zombies-game"
      src={gameUrl}
      title="Play tank-vs-zombies"
