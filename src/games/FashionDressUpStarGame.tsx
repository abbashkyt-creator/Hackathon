...
const GAME_SOURCE = "tiptap-fashion-dress-up-star";
const PARENT_SOURCE = "tiptap-parent";

export function FashionDressUpStarGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/fashion-dress-up-star/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena fashion-dress-up-star-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena fashion-dress-up-star-game"
      src={gameUrl}
      title="Play fashion-dress-up-star"
