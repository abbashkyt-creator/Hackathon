...
const GAME_SOURCE = "tiptap-annoying-teacher-punch-game";
const PARENT_SOURCE = "tiptap-parent";

export function AnnoyingTeacherPunchGameGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/annoying-teacher-punch-game/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena annoying-teacher-punch-game-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena annoying-teacher-punch-game-game"
      src={gameUrl}
      title="Play annoying-teacher-punch-game"
