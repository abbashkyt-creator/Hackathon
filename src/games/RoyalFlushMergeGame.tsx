...
const GAME_SOURCE = "tiptap-royal-flush-merge";
const PARENT_SOURCE = "tiptap-parent";

export function RoyalFlushMergeGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/royal-flush-merge/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena royal-flush-merge-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena royal-flush-merge-game"
      src={gameUrl}
      title="Play royal-flush-merge"
