...
const GAME_SOURCE = "tiptap-domino";
...
export function DominoGame({
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/domino/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena domino-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena domino-game"
      src={gameUrl}
      title="Play domino"
