...
const GAME_SOURCE = "tiptap-spider-solitaire";
...
export function SpiderSolitaireGame({
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/spider-solitaire/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena spider-solitaire-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena spider-solitaire-game"
      src={gameUrl}
      title="Play Spider Solitaire Plus"
