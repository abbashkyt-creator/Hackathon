...
const GAME_SOURCE = "tiptap-perfect-landing-plane-pilot";
const PARENT_SOURCE = "tiptap-parent";

export function PerfectLandingPlanePilotGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/perfect-landing-plane-pilot/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena perfect-landing-plane-pilot-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena perfect-landing-plane-pilot-game"
      src={gameUrl}
      title="Play perfect-landing-plane-pilot"
