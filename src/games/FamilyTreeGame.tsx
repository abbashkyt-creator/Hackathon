...
const GAME_SOURCE = "tiptap-family-tree";
...
export function FamilyTreeGame({
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/family-tree/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena family-tree-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena family-tree-game"
      src={gameUrl}
      title="Play family-tree"
