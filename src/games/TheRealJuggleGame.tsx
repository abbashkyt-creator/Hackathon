...
const GAME_SOURCE = "tiptap-the-real-juggle";
const PARENT_SOURCE = "tiptap-parent";

export function TheRealJuggleGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/the-real-juggle/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena the-real-juggle-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena the-real-juggle-game"
      src={gameUrl}
      title="Play the-real-juggle"
