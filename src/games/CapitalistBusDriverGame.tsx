...
const GAME_SOURCE = "tiptap-capitalist-bus-driver";
const PARENT_SOURCE = "tiptap-parent";

export function CapitalistBusDriverGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/capitalist-bus-driver/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena capitalist-bus-driver-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena capitalist-bus-driver-game"
      src={gameUrl}
      title="Play capitalist-bus-driver"
