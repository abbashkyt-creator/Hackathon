...
const GAME_SOURCE = "tiptap-world-of-screw";
const PARENT_SOURCE = "tiptap-parent";

export function WorldOfScrewGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/world-of-screw/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena world-of-screw-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena world-of-screw-game"
      src={gameUrl}
      title="Play world-of-screw"
