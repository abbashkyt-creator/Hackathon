...
const GAME_SOURCE = "tiptap-pizza-day";
const PARENT_SOURCE = "tiptap-parent";

export function PizzaDayGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/pizza-day/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena pizza-day-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena pizza-day-game"
      src={gameUrl}
      title="Play pizza-day"
