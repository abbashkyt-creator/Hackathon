...
const GAME_SOURCE = "tiptap-scary-teacher-hide-seek-games";
const PARENT_SOURCE = "tiptap-parent";

export function ScaryTeacherHideSeekGamesGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/scary-teacher-hide-seek-games/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena scary-teacher-hide-seek-games-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena scary-teacher-hide-seek-games-game"
      src={gameUrl}
      title="Play scary-teacher-hide-seek-games"
