...
const GAME_SOURCE = "tiptap-cozyville-find-hidden-objects";
const PARENT_SOURCE = "tiptap-parent";

export function CozyvilleFindHiddenObjectsGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/cozyville-find-hidden-objects/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena cozyville-find-hidden-objects-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena cozyville-find-hidden-objects-game"
      src={gameUrl}
      title="Play cozyville-find-hidden-objects"
