...
const GAME_SOURCE = "tiptap-snapstyle-dress-up";
const PARENT_SOURCE = "tiptap-parent";

export function SnapstyleDressUpGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/snapstyle-dress-up/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena snapstyle-dress-up-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena snapstyle-dress-up-game"
      src={gameUrl}
      title="Play SnapStyle Dress-up"
