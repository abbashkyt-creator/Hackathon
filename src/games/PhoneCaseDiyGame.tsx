...
const GAME_SOURCE = "tiptap-phone-case-diy";
const PARENT_SOURCE = "tiptap-parent";

export function PhoneCaseDiyGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/phone-case-diy/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena phone-case-diy-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena phone-case-diy-game"
      src={gameUrl}
      title="Play Case Coloring"
