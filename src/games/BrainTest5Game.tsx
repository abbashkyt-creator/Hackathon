...
const GAME_SOURCE = "tiptap-brain-test-5";
const PARENT_SOURCE = "tiptap-parent";

export function BrainTest5Game({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/brain-test-5/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena brain-test-5-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena brain-test-5-game"
      src={gameUrl}
      title="Play brain-test-5"
