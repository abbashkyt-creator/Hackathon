...
const GAME_SOURCE = "tiptap-mad-skills-motocross-2";
const PARENT_SOURCE = "tiptap-parent";

export function MadSkillsMotocross2Game({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/mad-skills-motocross-2/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena mad-skills-motocross-2-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena mad-skills-motocross-2-game"
      src={gameUrl}
      title="Play mad-skills-motocross-2"
