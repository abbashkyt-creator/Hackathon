...
const GAME_SOURCE = "tiptap-wreck-the-robot";
const PARENT_SOURCE = "tiptap-parent";

export function WreckTheRobotGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/wreck-the-robot/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena wreck-the-robot-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena wreck-the-robot-game"
      src={gameUrl}
      title="Play wreck-the-robot"
