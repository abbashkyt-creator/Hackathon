...
const GAME_SOURCE = "tiptap-goalheads-io";
const PARENT_SOURCE = "tiptap-parent";

export function GoalheadsIoGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/goalheads-io/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena goalheads-io-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena goalheads-io-game"
      src={gameUrl}
      title="Play goalheads-io"
