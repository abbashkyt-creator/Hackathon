...
const GAME_SOURCE = "tiptap-dogs-life";
const PARENT_SOURCE = "tiptap-parent";

export function DogsLifeGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/dogs-life/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena dogs-life-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena dogs-life-game"
      src={gameUrl}
      title="Play dogs-life"
