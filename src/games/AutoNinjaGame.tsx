...
const GAME_SOURCE = "tiptap-auto-ninja";
const PARENT_SOURCE = "tiptap-parent";

export function AutoNinjaGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/auto-ninja/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena auto-ninja-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena auto-ninja-game"
      src={gameUrl}
      title="Play auto-ninja"
