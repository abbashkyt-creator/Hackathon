...
const GAME_SOURCE = "tiptap-beardie-craft-survival";
const PARENT_SOURCE = "tiptap-parent";

export function BeardieCraftSurvivalGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/beardie-craft-survival/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena beardie-craft-survival-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena beardie-craft-survival-game"
      src={gameUrl}
      title="Play beardie-craft-survival"
