...
const GAME_SOURCE = "tiptap-pocket-car-city";
const PARENT_SOURCE = "tiptap-parent";

export function PocketCarCityGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/pocket-car-city/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena pocket-car-city-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena pocket-car-city-game"
      src={gameUrl}
      title="Play pocket-car-city"
