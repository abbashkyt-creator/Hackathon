...
const GAME_SOURCE = "tiptap-stunt-protocol-two-players";
const PARENT_SOURCE = "tiptap-parent";

export function StuntProtocolTwoPlayersGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/stunt-protocol-two-players/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena stunt-protocol-two-players-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena stunt-protocol-two-players-game"
      src={gameUrl}
      title="Play stunt-protocol-two-players"
