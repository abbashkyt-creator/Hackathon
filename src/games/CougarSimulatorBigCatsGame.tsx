...
const GAME_SOURCE = "tiptap-cougar-simulator-big-cats";
const PARENT_SOURCE = "tiptap-parent";

export function CougarSimulatorBigCatsGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/cougar-simulator-big-cats/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena cougar-simulator-big-cats-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena cougar-simulator-big-cats-game"
      src={gameUrl}
      title="Play cougar-simulator-big-cats"
