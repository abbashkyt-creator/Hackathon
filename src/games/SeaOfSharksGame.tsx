...
const GAME_SOURCE = "tiptap-sea-of-sharks";
const PARENT_SOURCE = "tiptap-parent";

export function SeaOfSharksGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/sea-of-sharks/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena sea-of-sharks-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena sea-of-sharks-game"
      src={gameUrl}
      title="Play sea-of-sharks"
