...
const GAME_SOURCE = "tiptap-pull-a-sword";
const PARENT_SOURCE = "tiptap-parent";

export function PullASwordGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/pull-a-sword/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena pull-a-sword-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena pull-a-sword-game"
      src={gameUrl}
      title="Play pull-a-sword"
