...
const GAME_SOURCE = "tiptap-merge-monster-battles";
const PARENT_SOURCE = "tiptap-parent";

export function MergeMonsterBattlesGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/merge-monster-battles/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena merge-monster-battles-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena merge-monster-battles-game"
      src={gameUrl}
      title="Play merge-monster-battles"
