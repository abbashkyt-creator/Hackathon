...
const GAME_SOURCE = "tiptap-world-soccer-champions";
const PARENT_SOURCE = "tiptap-parent";

export function WorldSoccerChampionsGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/world-soccer-champions/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena world-soccer-champions-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena world-soccer-champions-game"
      src={gameUrl}
      title="Play world-soccer-champions"
