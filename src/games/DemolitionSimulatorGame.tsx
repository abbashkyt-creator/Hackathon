...
const GAME_SOURCE = "tiptap-demolition-simulator";
const PARENT_SOURCE = "tiptap-parent";

export function DemolitionSimulatorGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/demolition-simulator/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena demolition-simulator-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena demolition-simulator-game"
      src={gameUrl}
      title="Play demolition-simulator"
