...
const GAME_SOURCE = "tiptap-noob-archer-2";
const PARENT_SOURCE = "tiptap-parent";

export function NoobArcher2Game({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/noob-archer-2/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena noob-archer-2-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena noob-archer-2-game"
      src={gameUrl}
      title="Play Noob Archer 2"
