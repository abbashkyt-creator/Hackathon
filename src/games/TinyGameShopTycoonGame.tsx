...
const GAME_SOURCE = "tiptap-tiny-game-shop-tycoon";
const PARENT_SOURCE = "tiptap-parent";

export function TinyGameShopTycoonGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/tiny-game-shop-tycoon/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena tiny-game-shop-tycoon-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena tiny-game-shop-tycoon-game"
      src={gameUrl}
      title="Play tiny-game-shop-tycoon"
