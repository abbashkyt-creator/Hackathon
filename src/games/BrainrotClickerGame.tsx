...
const GAME_SOURCE = "tiptap-brainrot-clicker";
const PARENT_SOURCE = "tiptap-parent";

export function BrainrotClickerGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/brainrot-clicker/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena brainrot-clicker-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena brainrot-clicker-game"
      src={gameUrl}
      title="Play brainrot-clicker"
