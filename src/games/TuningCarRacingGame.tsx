...
const GAME_SOURCE = "tiptap-tuning-car-racing";
const PARENT_SOURCE = "tiptap-parent";

export function TuningCarRacingGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/tuning-car-racing/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena tuning-car-racing-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena tuning-car-racing-game"
      src={gameUrl}
      title="Play tuning-car-racing"
