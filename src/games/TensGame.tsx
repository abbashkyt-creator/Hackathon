...
export function TensGame({
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/tens/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena tens-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena tens-game"
      src={gameUrl}
      title="Play tens"
