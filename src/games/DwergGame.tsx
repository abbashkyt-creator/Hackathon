...
const GAME_SOURCE = "tiptap-dwerg";
const PARENT_SOURCE = "tiptap-parent";

export function DwergGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/dwerg/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena dwerg-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena dwerg-game"
      src={gameUrl}
      title="Play dwerg"
