...
const GAME_SOURCE = "tiptap-freaky-clown-town-mystery";
const PARENT_SOURCE = "tiptap-parent";

export function FreakyClownTownMysteryGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/freaky-clown-town-mystery/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena freaky-clown-town-mystery-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena freaky-clown-town-mystery-game"
      src={gameUrl}
      title="Play freaky-clown-town-mystery"
