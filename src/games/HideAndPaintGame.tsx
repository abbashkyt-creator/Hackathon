...
const GAME_SOURCE = "tiptap-hide-and-paint";
const PARENT_SOURCE = "tiptap-parent";

export function HideAndPaintGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/hide-and-paint/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena hide-and-paint-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena hide-and-paint-game"
      src={gameUrl}
      title="Play Hide and paint - v62"
