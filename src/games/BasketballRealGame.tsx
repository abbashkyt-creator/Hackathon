...
const GAME_SOURCE = "tiptap-basketball-real";
const PARENT_SOURCE = "tiptap-parent";

export function BasketballRealGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/basketball-real/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena basketball-real-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena basketball-real-game"
      src={gameUrl}
      title="Play basketball-real"
