...
const GAME_SOURCE = "tiptap-tiny-baker-ocean-jelly-cake";
const PARENT_SOURCE = "tiptap-parent";

export function TinyBakerOceanJellyCakeGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/tiny-baker-ocean-jelly-cake/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena tiny-baker-ocean-jelly-cake-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena tiny-baker-ocean-jelly-cake-game"
      src={gameUrl}
      title="Play Tiny Baker Ocean Jelly Cake"
