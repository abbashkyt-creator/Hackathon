...
const GAME_SOURCE = "tiptap-the-third-piglets-tower";
const PARENT_SOURCE = "tiptap-parent";

export function TheThirdPigletsTowerGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/the-third-piglets-tower/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena the-third-piglets-tower-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena the-third-piglets-tower-game"
      src={gameUrl}
      title="Play the-third-piglets-tower"
