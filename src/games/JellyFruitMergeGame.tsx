...
const GAME_SOURCE = "tiptap-jelly-fruit-merge";
const PARENT_SOURCE = "tiptap-parent";

export function JellyFruitMergeGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/jelly-fruit-merge/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena jelly-fruit-merge-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena jelly-fruit-merge-game"
      src={gameUrl}
      title="Play jelly-fruit-merge"
