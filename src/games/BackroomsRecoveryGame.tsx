...
const GAME_SOURCE = "tiptap-backrooms-recovery";
const PARENT_SOURCE = "tiptap-parent";

export function BackroomsRecoveryGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/backrooms-recovery/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena backrooms-recovery-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena backrooms-recovery-game"
      src={gameUrl}
      title="Play backrooms-recovery"
