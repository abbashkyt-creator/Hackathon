...
const GAME_SOURCE = "tiptap-school-cleaning";
const PARENT_SOURCE = "tiptap-parent";

export function SchoolCleaningGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/school-cleaning/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena school-cleaning-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena school-cleaning-game"
      src={gameUrl}
      title="Play school-cleaning"
