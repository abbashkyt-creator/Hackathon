...
const GAME_SOURCE = "tiptap-soccer-league";
const PARENT_SOURCE = "tiptap-parent";

export function SoccerLeagueGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/soccer-league/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena soccer-league-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena soccer-league-game"
      src={gameUrl}
      title="Play soccer-league"
