...
const GAME_SOURCE = "tiptap-moms-diary-cooking-games";
const PARENT_SOURCE = "tiptap-parent";

export function MomsDiaryCookingGamesGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/moms-diary-cooking-games/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena moms-diary-cooking-games-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena moms-diary-cooking-games-game"
      src={gameUrl}
      title="Play moms-diary-cooking-games"
