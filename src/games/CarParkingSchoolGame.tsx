...
const GAME_SOURCE = "tiptap-car-parking-school";
const PARENT_SOURCE = "tiptap-parent";

export function CarParkingSchoolGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/car-parking-school/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena car-parking-school-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena car-parking-school-game"
      src={gameUrl}
      title="Play car-parking-school"
