...
const GAME_SOURCE = "tiptap-carnado-boat-racing";
const PARENT_SOURCE = "tiptap-parent";

export function CarnadoBoatRacingGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/carnado-boat-racing/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena carnado-boat-racing-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena carnado-boat-racing-game"
      src={gameUrl}
      title="Play Carnado Boat Racing"
