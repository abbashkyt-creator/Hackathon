...
const GAME_SOURCE = "tiptap-planet-destruction";
const PARENT_SOURCE = "tiptap-parent";

export function PlanetDestructionGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/planet-destruction/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena planet-destruction-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena planet-destruction-game"
      src={gameUrl}
      title="Play planet-destruction"
