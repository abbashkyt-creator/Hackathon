...
const GAME_SOURCE = "tiptap-home-builder-clicker";
const PARENT_SOURCE = "tiptap-parent";

export function HomeBuilderClickerGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/home-builder-clicker/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena home-builder-clicker-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena home-builder-clicker-game"
      src={gameUrl}
      title="Play home-builder-clicker"
