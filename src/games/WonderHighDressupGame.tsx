...
const GAME_SOURCE = "tiptap-wonder-high-dressup";
const PARENT_SOURCE = "tiptap-parent";

export function WonderHighDressupGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/wonder-high-dressup/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena wonder-high-dressup-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena wonder-high-dressup-game"
      src={gameUrl}
      title="Play wonder-high-dressup"
