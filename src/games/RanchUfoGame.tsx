...
const GAME_SOURCE = "tiptap-ranch-ufo";
const PARENT_SOURCE = "tiptap-parent";

export function RanchUfoGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/ranch-ufo/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena ranch-ufo-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena ranch-ufo-game"
      src={gameUrl}
      title="Play ranch-ufo"
