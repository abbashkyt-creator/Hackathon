...
const GAME_SOURCE = "tiptap-hot-air";
const PARENT_SOURCE = "tiptap-parent";

export function HotAirGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/hot-air/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena hot-air-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena hot-air-game"
      src={gameUrl}
      title="Play hot-air"
