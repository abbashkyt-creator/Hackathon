...
const GAME_SOURCE = "tiptap-soccer-real";
const PARENT_SOURCE = "tiptap-parent";

export function SoccerRealGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/soccer-real/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) {
    return <div className="game-arena soccer-real-placeholder" aria-hidden="true" />;
  }

  return (
    <iframe
      ref={frameRef}
      className="game-arena soccer-real-game"
      src={gameUrl}
      title="Play Soccer REAL"
