...
const GAME_SOURCE = "tiptap-tds-tower-destiny-survive";
const PARENT_SOURCE = "tiptap-parent";

export function TdsTowerDestinySurviveGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/tds-tower-destiny-survive/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena tds-tower-destiny-survive-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena tds-tower-destiny-survive-game"
      src={gameUrl}
      title="Play tds-tower-destiny-survive"
