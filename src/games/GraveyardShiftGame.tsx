...
const GAME_SOURCE = "tiptap-graveyard-shift";
const PARENT_SOURCE = "tiptap-parent";

export function GraveyardShiftGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/graveyard-shift/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena graveyard-shift-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena graveyard-shift-game"
      src={gameUrl}
      title="Play graveyard-shift"
