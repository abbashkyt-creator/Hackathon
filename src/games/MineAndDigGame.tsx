...
const GAME_SOURCE = "tiptap-mine-and-dig";
const PARENT_SOURCE = "tiptap-parent";

export function MineAndDigGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/mine-and-dig/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena mine-and-dig-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena mine-and-dig-game"
      src={gameUrl}
      title="Play mine-and-dig"
