...
const GAME_SOURCE = "tiptap-little-farm-world";
const PARENT_SOURCE = "tiptap-parent";

export function LittleFarmWorldGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/little-farm-world/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena little-farm-world-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena little-farm-world-game"
      src={gameUrl}
      title="Play little-farm-world"
