...
const GAME_SOURCE = "tiptap-family-life-simulator";
const PARENT_SOURCE = "tiptap-parent";

export function FamilyLifeSimulatorGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/family-life-simulator/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena family-life-simulator-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena family-life-simulator-game"
      src={gameUrl}
      title="Play family-life-simulator"
