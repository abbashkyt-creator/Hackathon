...
const GAME_SOURCE = "tiptap-snacky-snake";
const PARENT_SOURCE = "tiptap-parent";

export function SnackySnakeGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/snacky-snake/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena snacky-snake-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena snacky-snake-game"
      src={gameUrl}
      title="Play snacky-snake"
