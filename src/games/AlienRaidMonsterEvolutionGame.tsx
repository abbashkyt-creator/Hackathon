...
const GAME_SOURCE = "tiptap-alien-raid-monster-evolution";
const PARENT_SOURCE = "tiptap-parent";

export function AlienRaidMonsterEvolutionGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/alien-raid-monster-evolution/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena alien-raid-monster-evolution-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena alien-raid-monster-evolution-game"
      src={gameUrl}
      title="Play alien-raid-monster-evolution"
