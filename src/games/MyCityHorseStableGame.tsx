...
const GAME_SOURCE = "tiptap-my-city-horse-stable";
const PARENT_SOURCE = "tiptap-parent";

export function MyCityHorseStableGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/my-city-horse-stable/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena my-city-horse-stable-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena my-city-horse-stable-game"
      src={gameUrl}
      title="Play my-city-horse-stable"
