...
const GAME_SOURCE = "tiptap-neon-challenge-legends";
const PARENT_SOURCE = "tiptap-parent";

export function NeonChallengeLegendsGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/neon-challenge-legends/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena neon-challenge-legends-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena neon-challenge-legends-game"
      src={gameUrl}
      title="Play neon-challenge-legends"
