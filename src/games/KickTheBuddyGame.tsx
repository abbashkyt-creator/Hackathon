...
const GAME_SOURCE = "tiptap-kick-the-buddy";
const PARENT_SOURCE = "tiptap-parent";

export function KickTheBuddyGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/kick-the-buddy/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena kick-the-buddy-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena kick-the-buddy-game"
      src={gameUrl}
      title="Play kick-the-buddy"
