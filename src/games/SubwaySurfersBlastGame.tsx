...
const GAME_SOURCE = "tiptap-subway-surfers-blast";
const PARENT_SOURCE = "tiptap-parent";

export function SubwaySurfersBlastGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/subway-surfers-blast/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena subway-surfers-blast-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena subway-surfers-blast-game"
      src={gameUrl}
      title="Play subway-surfers-blast"
