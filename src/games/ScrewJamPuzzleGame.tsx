...
const GAME_SOURCE = "tiptap-screw-jam-puzzle";
const PARENT_SOURCE = "tiptap-parent";

export function ScrewJamPuzzleGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/screw-jam-puzzle/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena screw-jam-puzzle-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena screw-jam-puzzle-game"
      src={gameUrl}
      title="Play screw-jam-puzzle"
