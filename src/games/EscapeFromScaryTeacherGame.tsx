...
const GAME_SOURCE = "tiptap-escape-from-scary-teacher";
const PARENT_SOURCE = "tiptap-parent";

export function EscapeFromScaryTeacherGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/escape-from-scary-teacher/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena escape-from-scary-teacher-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena escape-from-scary-teacher-game"
      src={gameUrl}
      title="Play escape-from-scary-teacher"
