...
const GAME_SOURCE = "tiptap-harvest-simulator";
const PARENT_SOURCE = "tiptap-parent";

export function HarvestSimulatorGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/harvest-simulator/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena harvest-simulator-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena harvest-simulator-game"
      src={gameUrl}
      title="Play harvest-simulator"
