...
const GAME_SOURCE = "tiptap-dino-game";
...
export function DinoRunnerGame({
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/dino-game/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) {
    return <div className="game-arena dino-runner-placeholder" aria-hidden="true" />;
  }

  return (
    <iframe
      ref={frameRef}
      className="game-arena dino-runner-game"
      src={gameUrl}
      title="Play Dinosaur Game"
