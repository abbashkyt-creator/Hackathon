...
const GAME_SOURCE = "tiptap-life-choices-2-life-simulator";
const PARENT_SOURCE = "tiptap-parent";

export function LifeChoices2LifeSimulatorGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/life-choices-2-life-simulator/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena life-choices-2-life-simulator-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena life-choices-2-life-simulator-game"
      src={gameUrl}
      title="Play life-choices-2-life-simulator"
