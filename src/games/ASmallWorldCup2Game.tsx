...
const GAME_SOURCE = "tiptap-a-small-world-cup-2";
const PARENT_SOURCE = "tiptap-parent";

export function ASmallWorldCup2Game({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/a-small-world-cup-2/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena a-small-world-cup-2-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena a-small-world-cup-2-game"
      src={gameUrl}
      title="Play a-small-world-cup-2"
