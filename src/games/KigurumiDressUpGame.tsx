...
const GAME_SOURCE = "tiptap-kigurumi-dress-up";
const PARENT_SOURCE = "tiptap-parent";

export function KigurumiDressUpGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/kigurumi-dress-up/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena kigurumi-dress-up-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena kigurumi-dress-up-game"
      src={gameUrl}
      title="Play kigurumi-dress-up"
