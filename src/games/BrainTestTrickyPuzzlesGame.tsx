...
const GAME_SOURCE = "tiptap-brain-test-tricky-puzzles";
const PARENT_SOURCE = "tiptap-parent";

export function BrainTestTrickyPuzzlesGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/brain-test-tricky-puzzles/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena brain-test-tricky-puzzles-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena brain-test-tricky-puzzles-game"
      src={gameUrl}
      title="Play Brain Test"
