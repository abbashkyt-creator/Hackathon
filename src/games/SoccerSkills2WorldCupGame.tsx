...
const GAME_SOURCE = "tiptap-soccer-skills-2-world-cup";
const PARENT_SOURCE = "tiptap-parent";

export function SoccerSkills2WorldCupGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/soccer-skills-2-world-cup/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena soccer-skills-2-world-cup-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena soccer-skills-2-world-cup-game"
      src={gameUrl}
      title="Play soccer-skills-2-world-cup"
