...
const GAME_SOURCE = "tiptap-my-cozy-home";
const PARENT_SOURCE = "tiptap-parent";

export function MyCozyHomeGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/my-cozy-home/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena my-cozy-home-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena my-cozy-home-game"
      src={gameUrl}
      title="Play my-cozy-home"
