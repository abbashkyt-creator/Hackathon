...
const GAME_SOURCE = "tiptap-fashion-fix-studio";
const PARENT_SOURCE = "tiptap-parent";

export function FashionFixStudioGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/fashion-fix-studio/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena fashion-fix-studio-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena fashion-fix-studio-game"
      src={gameUrl}
      title="Play Fashion Fix Studio"
