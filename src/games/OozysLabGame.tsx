...
const GAME_SOURCE = "tiptap-oozys-lab";
const PARENT_SOURCE = "tiptap-parent";

export function OozysLabGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/oozys-lab/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena oozys-lab-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena oozys-lab-game"
      src={gameUrl}
      title="Play oozys-lab"
