...
const GAME_SOURCE = "tiptap-the-superhero-league-2";
const PARENT_SOURCE = "tiptap-parent";

export function TheSuperheroLeague2Game({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/the-superhero-league-2/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena the-superhero-league-2-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena the-superhero-league-2-game"
      src={gameUrl}
      title="Play the-superhero-league-2"
