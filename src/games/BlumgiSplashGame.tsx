...
const GAME_SOURCE = "tiptap-blumgi-splash";
const PARENT_SOURCE = "tiptap-parent";

export function BlumgiSplashGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  if (!active) return <div className="game-arena blumgi-splash-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena blumgi-splash-game"
      src={gameUrl}
      title="Play blumgi-splash"
