...
const GAME_SOURCE = "tiptap-bounce-ball";
...
export function BounceBallGame({
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/bounce-ball/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena bounce-ball-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena bounce-ball-game"
      src={gameUrl}
      title="Play bounce-ball"
