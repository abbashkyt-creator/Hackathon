...
const GAME_SOURCE = "tiptap-hill-climb-racing-lite";
const PARENT_SOURCE = "tiptap-parent";

export function HillClimbRacingLiteGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/hill-climb-racing-lite/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena hill-climb-racing-lite-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena hill-climb-racing-lite-game"
      src={gameUrl}
      title="Play hill-climb-racing-lite"
