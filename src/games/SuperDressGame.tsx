...
const GAME_SOURCE = "tiptap-super-dress";
const PARENT_SOURCE = "tiptap-parent";

export function SuperDressGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/super-dress/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena super-dress-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena super-dress-game"
      src={gameUrl}
      title="Play SuperDress"
