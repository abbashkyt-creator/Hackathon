...
const GAME_SOURCE = "tiptap-airplane-manager";
const PARENT_SOURCE = "tiptap-parent";

export function AirplaneManagerGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/airplane-manager/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena airplane-manager-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena airplane-manager-game"
      src={gameUrl}
      title="Play airplane-manager"
