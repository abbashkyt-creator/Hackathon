...
const GAME_SOURCE = "tiptap-clash-of-cards";
const PARENT_SOURCE = "tiptap-parent";

export function ClashOfCardsGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/clash-of-cards/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena clash-of-cards-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena clash-of-cards-game"
      src={gameUrl}
      title="Play clash-of-cards"
