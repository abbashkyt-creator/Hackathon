...
const GAME_SOURCE = "tiptap-idle-spinner-factory-builder";
const PARENT_SOURCE = "tiptap-parent";

export function IdleSpinnerFactoryBuilderGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/idle-spinner-factory-builder/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena idle-spinner-factory-builder-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena idle-spinner-factory-builder-game"
      src={gameUrl}
      title="Play idle-spinner-factory-builder"
