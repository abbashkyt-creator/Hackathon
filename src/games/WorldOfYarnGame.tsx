...
const GAME_SOURCE = "tiptap-world-of-yarn";
const PARENT_SOURCE = "tiptap-parent";

export function WorldOfYarnGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/world-of-yarn/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena world-of-yarn-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena world-of-yarn-game"
      src={gameUrl}
      title="Play world-of-yarn"
