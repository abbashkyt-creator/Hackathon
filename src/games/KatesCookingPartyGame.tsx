...
const GAME_SOURCE = "tiptap-kates-cooking-party";
const PARENT_SOURCE = "tiptap-parent";

export function KatesCookingPartyGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/kates-cooking-party/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena kates-cooking-party-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena kates-cooking-party-game"
      src={gameUrl}
      title="Play kates-cooking-party"
