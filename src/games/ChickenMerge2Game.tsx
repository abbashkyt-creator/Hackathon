...
const GAME_SOURCE = "tiptap-chicken-merge-2";
const PARENT_SOURCE = "tiptap-parent";

export function ChickenMerge2Game({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/chicken-merge-2/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena chicken-merge-2-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena chicken-merge-2-game"
      src={gameUrl}
      title="Play chicken-merge-2"
