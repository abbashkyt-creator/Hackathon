...
const GAME_SOURCE = "tiptap-tear-blocks-down";
const PARENT_SOURCE = "tiptap-parent";

export function TearBlocksDownGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/tear-blocks-down/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena tear-blocks-down-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena tear-blocks-down-game"
      src={gameUrl}
      title="Play tear-blocks-down"
