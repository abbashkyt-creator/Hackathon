...
const GAME_SOURCE = "tiptap-blockpost-legacy";
const PARENT_SOURCE = "tiptap-parent";

export function BlockpostLegacyGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/blockpost-legacy/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena blockpost-legacy-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena blockpost-legacy-game"
      src={gameUrl}
      title="Play blockpost-legacy"
