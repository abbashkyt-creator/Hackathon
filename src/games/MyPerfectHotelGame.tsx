...
const GAME_SOURCE = "tiptap-my-perfect-hotel";
const PARENT_SOURCE = "tiptap-parent";

export function MyPerfectHotelGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/my-perfect-hotel/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena my-perfect-hotel-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena my-perfect-hotel-game"
      src={gameUrl}
      title="Play My Perfect Hotel - Poki"
