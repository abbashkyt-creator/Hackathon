...
const GAME_SOURCE = "tiptap-4th-and-goal-2026";
const PARENT_SOURCE = "tiptap-parent";

export function G4thAndGoal2026Game({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/4th-and-goal-2026/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena 4th-and-goal-2026-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena 4th-and-goal-2026-game"
      src={gameUrl}
      title="Play 4th-and-goal-2026"
