...
const GAME_SOURCE = "tiptap-pet-mahjong-3d";
const PARENT_SOURCE = "tiptap-parent";

export function PetMahjong3dGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/pet-mahjong-3d/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena pet-mahjong-3d-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena pet-mahjong-3d-game"
      src={gameUrl}
      title="Play 3D Mahjong"
