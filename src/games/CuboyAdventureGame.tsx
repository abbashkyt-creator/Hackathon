...
const GAME_SOURCE = "tiptap-cuboy-adventure";
const PARENT_SOURCE = "tiptap-parent";

export function CuboyAdventureGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/cuboy-adventure/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena cuboy-adventure-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena cuboy-adventure-game"
      src={gameUrl}
      title="Play Cuboy"
