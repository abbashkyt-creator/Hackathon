...
const GAME_SOURCE = "tiptap-real-city-bikes";
const PARENT_SOURCE = "tiptap-parent";

export function RealCityBikesGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/real-city-bikes/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena real-city-bikes-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena real-city-bikes-game"
      src={gameUrl}
      title="Play real-city-bikes"
