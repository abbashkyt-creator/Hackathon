...
const GAME_SOURCE = "tiptap-johnny-trigger-sniper-game";
const PARENT_SOURCE = "tiptap-parent";

export function JohnnyTriggerSniperGameGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/johnny-trigger-sniper-game/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena johnny-trigger-sniper-game-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena johnny-trigger-sniper-game-game"
      src={gameUrl}
