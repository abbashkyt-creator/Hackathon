...
const GAME_SOURCE = "tiptap-going-up-rooftop";
const PARENT_SOURCE = "tiptap-parent";

export function GoingUpRooftopGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/going-up-rooftop/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena going-up-rooftop-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena going-up-rooftop-game"
      src={gameUrl}
      title="Play going-up-rooftop"
