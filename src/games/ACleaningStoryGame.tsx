...
const GAME_SOURCE = "tiptap-a-cleaning-story";
const PARENT_SOURCE = "tiptap-parent";

export function ACleaningStoryGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/a-cleaning-story/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena a-cleaning-story-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena a-cleaning-story-game"
      src={gameUrl}
      title="Play a-cleaning-story"
