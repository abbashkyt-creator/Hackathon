...
const GAME_SOURCE = "tiptap-cozy-garden-design";
const PARENT_SOURCE = "tiptap-parent";

export function CozyGardenDesignGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/cozy-garden-design/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena cozy-garden-design-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena cozy-garden-design-game"
      src={gameUrl}
      title="Play cozy-garden-design"
