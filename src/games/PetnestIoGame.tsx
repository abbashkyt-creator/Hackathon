...
const GAME_SOURCE = "tiptap-petnest-io";
const PARENT_SOURCE = "tiptap-parent";

export function PetnestIoGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/petnest-io/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena petnest-io-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena petnest-io-game"
      src={gameUrl}
      title="Play Petnest.io"
