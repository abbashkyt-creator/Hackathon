...
const GAME_SOURCE = "tiptap-nekopirate-quest-for-gold";
const PARENT_SOURCE = "tiptap-parent";

export function NekopirateQuestForGoldGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/nekopirate-quest-for-gold/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena nekopirate-quest-for-gold-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena nekopirate-quest-for-gold-game"
      src={gameUrl}
      title="Play nekopirate-quest-for-gold"
