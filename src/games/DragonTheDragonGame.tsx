...
const GAME_SOURCE = "tiptap-dragon-the-dragon";
const PARENT_SOURCE = "tiptap-parent";

export function DragonTheDragonGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/dragon-the-dragon/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena dragon-the-dragon-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena dragon-the-dragon-game"
      src={gameUrl}
      title="Play Dragon the Dragon"
