...
const GAME_SOURCE = "tiptap-satisbox-builder";
const PARENT_SOURCE = "tiptap-parent";

export function SatisboxBuilderGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/satisbox-builder/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena satisbox-builder-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena satisbox-builder-game"
      src={gameUrl}
      title="Play satisbox-builder"
