...
const GAME_SOURCE = "tiptap-mech-bots-arena";
const PARENT_SOURCE = "tiptap-parent";

export function MechBotsArenaGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/mech-bots-arena/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena mech-bots-arena-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena mech-bots-arena-game"
      src={gameUrl}
      title="Play mech-bots-arena"
