...
const GAME_SOURCE = "tiptap-evolution-game";
const PARENT_SOURCE = "tiptap-parent";

export function EvolutionGameGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/evolution-game/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena evolution-game-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena evolution-game-game"
      src={gameUrl}
      title="Play evolution-game"
