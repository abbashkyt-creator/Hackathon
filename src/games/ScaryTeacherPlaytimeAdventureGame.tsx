...
const GAME_SOURCE = "tiptap-scary-teacher-playtime-adventure";
const PARENT_SOURCE = "tiptap-parent";

export function ScaryTeacherPlaytimeAdventureGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/scary-teacher-playtime-adventure/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena scary-teacher-playtime-adventure-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena scary-teacher-playtime-adventure-game"
      src={gameUrl}
      title="Play scary-teacher-playtime-adventure"
