...
const GAME_SOURCE = "tiptap-slime-keyboard-escape";
const PARENT_SOURCE = "tiptap-parent";

export function SlimeKeyboardEscapeGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/slime-keyboard-escape/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena slime-keyboard-escape-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena slime-keyboard-escape-game"
      src={gameUrl}
      title="Play slime-keyboard-escape"
