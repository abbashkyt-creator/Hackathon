...
const GAME_SOURCE = "tiptap-brainrot-craft";
const PARENT_SOURCE = "tiptap-parent";

export function BrainrotCraftGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/brainrot-craft/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena brainrot-craft-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena brainrot-craft-game"
      src={gameUrl}
      title="Play brainrot-craft"
