...
const GAME_SOURCE = "tiptap-the-superhero-league";
const PARENT_SOURCE = "tiptap-parent";

export function TheSuperheroLeagueGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/the-superhero-league/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena the-superhero-league-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena the-superhero-league-game"
      src={gameUrl}
      title="Play the-superhero-league"
