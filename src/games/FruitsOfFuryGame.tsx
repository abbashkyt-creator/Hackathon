...
const GAME_SOURCE = "tiptap-fruits-of-fury";
const PARENT_SOURCE = "tiptap-parent";

export function FruitsOfFuryGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/fruits-of-fury/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena fruits-of-fury-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena fruits-of-fury-game"
      src={gameUrl}
      title="Play fruits-of-fury"
