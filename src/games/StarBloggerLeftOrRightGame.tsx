...
const GAME_SOURCE = "tiptap-star-blogger-left-or-right";
const PARENT_SOURCE = "tiptap-parent";

export function StarBloggerLeftOrRightGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/star-blogger-left-or-right/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena star-blogger-left-or-right-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena star-blogger-left-or-right-game"
      src={gameUrl}
      title="Play star-blogger-left-or-right"
