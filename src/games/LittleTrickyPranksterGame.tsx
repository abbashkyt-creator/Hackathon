...
const GAME_SOURCE = "tiptap-little-tricky-prankster";
const PARENT_SOURCE = "tiptap-parent";

export function LittleTrickyPranksterGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/little-tricky-prankster/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena little-tricky-prankster-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena little-tricky-prankster-game"
      src={gameUrl}
      title="Play little-tricky-prankster"
