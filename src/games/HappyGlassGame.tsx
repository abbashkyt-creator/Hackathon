...
const GAME_SOURCE = "tiptap-happy-glass";
const PARENT_SOURCE = "tiptap-parent";

export function HappyGlassGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/happy-glass/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) {
    return <div className="game-arena happy-glass-placeholder" aria-hidden="true" />;
  }

  return (
    <iframe
      ref={frameRef}
      className="game-arena happy-glass-game"
      src={gameUrl}
      title="Play Happy Glass"
