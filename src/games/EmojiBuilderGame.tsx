...
const GAME_SOURCE = "tiptap-emoji-builder";
const PARENT_SOURCE = "tiptap-parent";

export function EmojiBuilderGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/emoji-builder/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena emoji-builder-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena emoji-builder-game"
      src={gameUrl}
      title="Play emoji-builder"
