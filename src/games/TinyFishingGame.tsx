...
const GAME_SOURCE = "tiptap-tiny-fishing";
const PARENT_SOURCE = "tiptap-parent";

export function TinyFishingGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/tiny-fishing/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena tiny-fishing-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena tiny-fishing-game"
      src={gameUrl}
      title="Play Tiny Fishing by buyhtml5.com"
