...
const GAME_SOURCE = "tiptap-make-brainrots-online";
const PARENT_SOURCE = "tiptap-parent";

export function MakeBrainrotsOnlineGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/make-brainrots-online/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena make-brainrots-online-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena make-brainrots-online-game"
      src={gameUrl}
      title="Play Make Brainrots Online"
