...
const GAME_SOURCE = "tiptap-cube-miner-escape-from-prison";
const PARENT_SOURCE = "tiptap-parent";

export function CubeMinerEscapeFromPrisonGame({
  active,
  runKey,
  soundEnabled,
  hapticsEnabled,
  ...
  const gameUrl = useMemo(() => {
    ...
    return `/games/cube-miner-escape-from-prison/index.html?${params}`;
  }, [active, runKey]);
  ...
  if (!active) return <div className="game-arena cube-miner-escape-from-prison-placeholder" aria-hidden="true" />;

  return (
    <iframe
      ref={frameRef}
      className="game-arena cube-miner-escape-from-prison-game"
      src={gameUrl}
      title="Play cube-miner-escape-from-prison"
