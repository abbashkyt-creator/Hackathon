...
class MainScene extends _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__["Scene3D"] {
        ...
        //if(this.fruitFactory.isFinish()){
          //if(this.fruitFactory.positionWaterMelonUI()){
            ...
            window.parent.postMessage(
              { source: "tiptap-fruit-ninja", type: "ready" },
              window.location.origin
            );
            if (
              new URLSearchParams(window.location.search).get('autoplay') === '1' ||
              (window.__TIPTAP_FRUIT_START_REQUESTED__ && window.__TIPTAP_FRUIT_START_REQUESTED__())
            ) window.__TIPTAP_FRUIT_START__();
          //}
        //}
      }
  ...
  showResult(){
    ...
    if (typeof window.__TIPTAP_FRUIT_SCORE__ === 'function') window.__TIPTAP_FRUIT_SCORE__(this.gameData.score);
