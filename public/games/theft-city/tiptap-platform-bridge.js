(() => {
  ...
  window.PokiSDK = Object.freeze({
    ...
    gameplayStop: noop,
    setDebug: noop,
    commercialBreak: (options) => window.TipTapAds.commercial(options, "theft-city-commercial"),
    rewardedBreak: (options) => window.TipTapAds.rewarded(options, "theft-city-rewarded"),
    displayAd: (options) => window.TipTapAds.display(options, "theft-city-display"),
    destroyAd: noop,
