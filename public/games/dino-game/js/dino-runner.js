/*
 * This is a web accesable version of the build-in version of chrome://dino
 * Original created by: Edward Jung, Sebastien Gabriel and Alan Bettes
 */
(function() {
    'use strict';
    ...
    Runner.prototype = {
        ...
        gameOver: function() {
            ...
            this.stop();
            this.crashed = true;
            submitScore('distance', Math.round(this.distanceMeter.getActualDistance(this.distanceRan)));
