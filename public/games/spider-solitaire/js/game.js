var adInterval = null;
// time between interstitials is 120
var lastAdTime = 0;
var gameplayStarted = true;
var lastInterstitialTime = Date.now() - 30000;
var adPlaying = false;
...
displayAd = function() {
  adInterval = setInterval(function() {
    ...
    PokiSDK.displayAd(
      adContainer,
      SimpleGame.myGame.device.desktop && innerWidth >= 780 ? "728x90" : "320x50"
    );
...
var SimpleGame = /** @class */ (function () {
        ...
        PokiSDK.init().then(
         	...
         	{   
                ...
                window['adBreak']({
                    type: 'preroll',
                    name: 'preroll',
                    adBreakDone: () => { this.continueToGame(); }
                });
         		this.continueToGame();
         	}
         ).catch(
    ...
    SimpleGame.prototype.continueToGame = function () {
        ...
        var myContainer = document.getElementById("adContainer");
        if(!myContainer) {
    ...
    SimpleGame.prototype.preload = function () {
        ...
        this.game.load.script('webfont', 'js/webfontloader.js');
...
var GameContext = /** @class */ (function () {
    ...
    GameContext.commercialBreak = function () {
        if(adPlaying) return;
        var now = Date.now();
        if(now - lastInterstitialTime < 30000) {
          return;
        }
        adPlaying = true;
...
var ResizeManager = /** @class */ (function () {
    ...
    ResizeManager.update = function () {
        ...
        var deviceWidth = window.innerWidth;
        var deviceHeight = window.innerHeight;
        if(lastWidth != deviceWidth || lastHeight != deviceHeight) {
...
var ButtonScoringMode = /** @class */ (function () {
    function ButtonScoringMode(parent, x, y) {
        ...
        this.myGroup.scale.set(0.6);
        var standardTxt;
        if(Language.FRENCH)
            standardTxt = SimpleGame.myGame.add.text(0, 0, "Une enseigne", { font: "36px Overpass", fill: "#ffffff", fontWeight: "500", align: "Center" });
        else
            standardTxt = SimpleGame.myGame.add.text(0, 0, "One Suit", { font: "47px Overpass", fill: "#ffffff", fontWeight: "500", align: "Center" });
        standardTxt.lineSpacing -= 22;
        var vegasTxt;
        if(Language.FRENCH)
            vegasTxt = SimpleGame.myGame.add.text(0, 0, "Deux enseignes", { font: "36px Overpass", fill: "#ffffff", fontWeight: "500", align: "Center" });
        else
            vegasTxt = SimpleGame.myGame.add.text(0, 0, "Two Suits", { font: "47px Overpass", fill: "#ffffff", fontWeight: "500", align: "Center" });
        vegasTxt.lineSpacing -= 22;
        var cumulativeTxt;
        if(Language.FRENCH)
            cumulativeTxt = SimpleGame.myGame.add.text(0, 0, "Quatre enseignes", { font: "36px Overpass", fill: "#ffffff", fontWeight: "500", align: "Center" });
        else
            cumulativeTxt = SimpleGame.myGame.add.text(0, 0, "Four Suits", { font: "47px Overpass", fill: "#ffffff", fontWeight: "500", align: "Center" });
...
var SettingsPrompt = /** @class */ (function () {
    function SettingsPrompt() {
        ...
        this.myIconBg = SimpleGame.myGame.add.graphics(0, 0, this.myGroup);
        this.myIconBg.beginFill(0x000000);
        this.myIconBg.drawRoundedRect(-SettingsPrompt.WIDTH_FIXED / 2, -SettingsPrompt.HEIGHT_FIXED / 2, SettingsPrompt.WIDTH_FIXED + 20, SettingsPrompt.HEIGHT_FIXED - 120, 40);
        this.myIconBg.endFill();
        this.myIconBg.alpha = 1;
        var scale = Math.min(0.9 * SettingsPrompt.WIDTH_FIXED / ResizeManager.deviceWidth, 0.9 * SettingsPrompt.HEIGHT_FIXED / ResizeManager.deviceHeight);
        var scale = Math.min(0.95 * ResizeManager.deviceWidth / SettingsPrompt.WIDTH_FIXED, 0.95 * ResizeManager.deviceHeight / SettingsPrompt.HEIGHT_FIXED);
        ...
        var scoringModeControl = new ButtonScoringMode(this.myGroup, -SettingsPrompt.WIDTH_FIXED / 2 - 60, -SettingsPrompt.HEIGHT_FIXED / 2 + 120);
...
var TutorialPrompt = /** @class */ (function () {
    ...
    TutorialPrompt.prototype.closeScreen = function (closeScreen, arg1) {
        ...
        SimpleGame.myGame.time.events.add(3000, BoardManager.showTutorial1, this);
    };
    TutorialPrompt.onScreen = false;
...
var ButtonWithOverAndText = /** @class */ (function (_super) {
    ...
    ButtonWithOverAndText.prototype.setXY = function (x, y) {
        ...
        if (this.fixedTxtCoords) {
            ...
            this.text.y = this.imgNormal.y + 0.5 * (this.imgNormal.height - 0.85 * this.text.height) - 6;
        }
