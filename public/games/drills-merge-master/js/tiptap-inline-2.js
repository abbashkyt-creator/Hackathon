...
let loadPhrasesBase = [
    ...
    "Calibrating the drills",
    "Polishing glowing ores",
    "Merging mighty drills",
    "Counting mined riches",
    "Feeding the pets",
    "Digging deeper layers",
    "Tuning the ore detectors",
    "Crafting sturdy drill bits",
    "Lighting the mine tunnels",
    "Sorting rare ore stacks",
    "Revving up the mining engines"
];
