...
(function () {
  ...
  window.PokiSDK = {
    ...
    commercialBreak: function (options) { return window.TipTapAds.commercial(options, 'arithmetica-commercial'); },
    rewardedBreak: function (options) { return window.TipTapAds.rewarded(options, 'arithmetica-rewarded'); },
    displayAd: function (options) { return window.TipTapAds.display(options, 'arithmetica-display'); },
    destroyAd: function () {},
    happytime: function () {},
