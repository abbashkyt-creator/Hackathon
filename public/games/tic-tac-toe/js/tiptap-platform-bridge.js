/*
 * Tip Tap local platform bridge for TicTacToe (Cocos Creator).
 * Replaces PokiSDK with local lifecycle + score reporting. No remote SDK.
 */
(function () {
  'use strict';
  var GAME_SOURCE = 'tiptap-tic-tac-toe';
  ...
  function bootHooks() {
    ...
    window.setTimeout(function () { if (!scoreSent) sendScore(true); }, 180000);
