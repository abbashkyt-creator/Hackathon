...
(() => {
  ...
  window.PokiSDK = Object.freeze({
    ...
    gameplayStop: noop,
    setDebug: noop,
    commercialBreak: (options) => window.TipTapAds.commercial(options, "johnny-commercial"),
    rewardedBreak: (options) => window.TipTapAds.rewarded(options, "johnny-rewarded"),
    displayAd: (options) => window.TipTapAds.display(options, "johnny-display"),
    destroyAd: noop,
    customEvent: noop,
    logError: noop,
    measure: noop,
