"use strict";
(() => {
  // ../../c3-framework-core/node_modules/mime/dist/types/other.js
  ...
  // ../../c3-framework-core/node_modules/mime/dist/types/standard.js
  ...
  // ../../c3-framework-core/node_modules/mime/dist/src/Mime.js
  ...
  // ../../c3-framework-core/node_modules/mime/dist/src/index.js
  var src_default = new Mime_default(standard_default, other_default)._freeze();

  // ../../c3-framework-core/types/classes.ts
  var ClassUtils;
  ((ClassUtils2) => {
    function _trigger(inst, config, type) {
      if (type instanceof Function) {
        type = type.name;
      }
      inst.dispatchEvent(new globalThis.C3.Event(type));
      inst._trigger(
        globalThis.C3[ADDON_NAMESPACE[config.addonType]][config.id].Cnds[type]
      );
    }
    ClassUtils2._trigger = _trigger;
    function _getDebuggerProperties(inst, config) {
    ...
    ClassUtils2._getDebuggerProperties = _getDebuggerProperties;
    function _loop(inst, array, callback, onEndCallback) {
  ...
  ((Behavior2) => {
    ...
    Behavior2.Type = Type;
    function Instance2(config) {
      return class instance extends globalThis.ISDKBehaviorInstanceBase {
        trigger(type) {
          ClassUtils._trigger(this, config, type);
        }
        loop(array, callback, onEndCallback) {
    ...
    ((Editor2) => {
      ...
      Editor2.Instance = Instance3;
    })(Editor = Behavior2.Editor || (Behavior2.Editor = {}));
  })(Behavior || (Behavior = {}));
  var Plugin;
  ((Plugin2) => {
    const CLASSES = {
    ...
    Plugin2.Type = Type;
    function Instance2(config, type) {
      return class extends type {
        trigger(type2) {
          ClassUtils._trigger(this, config, type2);
        }
        loop(array, callback, onEndCallback) {
          ClassUtils._loop(this, array, callback, onEndCallback);
        }
    ...
    ((Editor2) => {
      ...
      function Instance3(config) {
        ...
        return class extends CLASSES2[config.type] {
          constructor(sdkType, inst) {
            super(sdkType, inst);
          }
          Release() {
      ...
      Editor2.Instance = Instance3;
    })(Editor = Plugin2.Editor || (Plugin2.Editor = {}));
  })(Plugin || (Plugin = {}));

  // ../../c3-framework-core/index.ts
  var Utils;
  ((Utils2) => {
    const camelCasedMap = /* @__PURE__ */ new Map();
    function camel(str) {
  ...
  function registerEditorClass(inst, SDK, config) {
    ...
    if (config.fileDependencies && Object.keys(config.fileDependencies)?.length) {
      ...
      Object.keys(fileDependencies).forEach((filename) => {
        ...
        if (type === "copy-to-output") {
          dependency.fileType = src_default.getType(filename);
        }
  ...
  function injectAces(addonBase, config) {
    addonBase.Acts = {};
    addonBase.Cnds = {};
    addonBase.Exps = {};
  ...
  function initPlugin(C3, config, opts) {
    const A_C = C3.Plugins[config.id] = opts?.Base ?? Plugin.Base(config);
    A_C.Type = opts?.Type ?? Plugin.Type(config);
    A_C.Instance = opts?.Instance ?? (config.type === "object" ? Plugin.Instance(config, globalThis.ISDKInstanceBase) : Plugin.Instance(config, globalThis.ISDKWorldInstanceBase));
    injectAces(A_C, config);
    return A_C;
  }
  function initBehavior(C3, config, opts) {
  ...
  var addon_default = {
    ...
    "Aces": {
      "actions": {
        "angleFromComponents": (inst) => inst.angleFromComponents,
        "setComponents": (inst) => inst.setComponents,
        "toZero": (inst) => inst.toZero,
        "toOne": (inst) => inst.toOne,
        "toLeft": (inst) => inst.toLeft,
        "toRight": (inst) => inst.toRight,
        "toUp": (inst) => inst.toUp,
        "toDown": (inst) => inst.toDown,
        "toFixed": (inst) => inst.toFixed,
        "add": (inst) => inst.add,
        "sub": (inst) => inst.sub,
        "scale": (inst) => inst.scale,
        "max": (inst) => inst.max,
        "min": (inst) => inst.min,
        "clamp": (inst) => inst.clamp,
        "normal": (inst) => inst.normal,
        "reflect": (inst) => inst.reflect,
        "project": (inst) => inst.project,
        "reject": (inst) => inst.reject,
        "sign": (inst) => inst.sign,
        "snapped": (inst) => inst.snapped
      },
      "conditions": {
        "isZero": (inst) => inst.isZero,
        "isNormalized": (inst) => inst.isNormalized,
        "isFinite": (inst) => inst.isFinite
      },
      "expressions": {
        "dist": (inst) => inst.dist,
        "sdist": (inst) => inst.sdist,
        "len": (inst) => inst.len,
        "aspect": (inst) => inst.aspect,
        "dot": (inst) => inst.dot,
        "cross": (inst) => inst.cross
      }
    },
    "typeDefs": []
  };
  ...
  // src/instance.ts
  var Instance = class extends Plugin.Instance(addon_default, globalThis.ISDKWorldInstanceBase) {
    constructor() {
      super();
      this._updateAngle();
    }
  ...
  // src/runtime.ts
  initRuntime(addon_default, { Instance: instance_default });
})();
