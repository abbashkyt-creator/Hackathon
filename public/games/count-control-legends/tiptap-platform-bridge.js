...
(() => {
  ...
  window.PokiSDK = Object.freeze({
    ...
    gameplayStop: noop,
    setDebug: noop,
    commercialBreak: (options) => window.TipTapAds.commercial(options, "count-control-commercial"),
    rewardedBreak: (options) => window.TipTapAds.rewarded(options, "count-control-rewarded"),
    displayAd: (options) => window.TipTapAds.display(options, "count-control-display"),
    destroyAd: noop,
