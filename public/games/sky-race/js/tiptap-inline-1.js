if (/iPhone|iPad|iPod|Android/i.test(navigator.userAgent)) {
            ...
            bridge
                ...
                .then(() => {
                    ...
                    unityLoader.src = 'Build/POKI_25.loader.js'
                    unityLoader.onload = () => {
                        createUnityInstance(
                            canvas,
                            {
                                dataUrl: 'Build/POKI_25.data.unityweb',
                                frameworkUrl: 'Build/POKI_25.framework.js.unityweb',
                                codeUrl: 'Build/POKI_25.wasm.unityweb',
                                streamingAssetsUrl: 'StreamingAssets',
                                companyName: 'Carrot Games',
                                productName: 'Crazy Descent',
                                productVersion: '25',
