...
export class ZeppelinObject extends LevelObject {
    ...
    _getMissileConfig() {
        ...
        return {
            ...
            damageToDragon:            Math.max(0,     Number(this.config.missileDamageToDragon   ?? mc.damageToDragon   ?? 25)),
    ...
    getDragonTargetWorld(dragonTarget, out = new THREE.Vector3()) {
        ...
        if (dragonTarget?.getWorldPosition) return dragonTarget.getWorldPosition(out);
        return null;
    }
    ...
    _updateFacingTarget(dragonTarget) {
    ...
    _updateMissileCombat(delta, dragonTarget) {
        if (
    ...
    update(delta, level, dragonTarget = null) {
        ...
        this._updateMissileCombat(delta, dragonTarget);
    }
