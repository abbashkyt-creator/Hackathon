...
export const CONFIG = {
    ...
    // When true, enemies (turrets, choppers, SAMs, zeppelins) attack the dragon immediately
    // without waiting for the dragon to damage them first.
    requireDamageBeforeAttack: true,
    minimapShowPlanes: true,
    minimapShowZeppelins: true,
    minimapShowSharks: false,
    minimapShowFighterJets: true,
    ...
    // Initial upward impulse used when the dragon leaves the ground.
    JUMP_FORCE: 20,
    ...
    // Fixed extra world-space Y offset for the dragon visual while grounded.
    dragonGroundOffsetY: 0.4,

    DRAGON_MODEL: {
        // Dragon GLB node names to hide when the player model loads. Timeline ActorTrack
    ...
    // Air speed below this value uses hover mode; at or above it the dragon switches to flying mode.
    hoverSpeedThreshold: 9,
    // While hovering within this world-space distance from the resolved surface below, keep the
    // dragon in hover so near-ground control stays stable and does not jump into full flight.
    ...
    // Minimum downward Y speed needed before the dragon switches to the dive animation.
    ...
    // How quickly horizontal speed is reduced while the dragon is turning around in flight.
    ...
    // Extra world-space headroom kept between the top of the sky gradient and the dragon's
    ...
    // Dragon spawn in world space. Leave `y` as null to spawn on the ground at the chosen X.
    DRAGON_CARRY: {
        maxLiftWeight: 250,
        // Objects at or below this weight allow full flight (hover/fly/glide/dive) while carried.
        // Above this threshold the dragon is locked to hover mode.
        ...
        // Auto-pickup moves the dragon so grab reaches the object's root before attaching.
        pickupAlignSpeed: 18,
    ...
    DRAGON_DRAG: {
        ...
        alignTolerance: 0.35,
        alignMaxDuration: 1,
        // Maximum vertical distance (world units) between the dragon's mouth and a grab point
        ...
        // After the dragon's mouth passes the reachable grab point, keep the button enabled
        ...
        draggedBehindDragonZOffset: 2.3,
    ...
    DRAGON_FIRE_COMBAT: {
        fireballDamage: 10,
        flameDamagePerSecond: 70,
        // Minimum seconds between tap-fired fireballs. Continuous flame is controlled separately.
        fireballCooldown: 0.3,
        // Continuous flame resource pool (fireballs do not consume this).
        maxFlameValue: 150,
        // Resource drained per second while breathing continuous flame.
        flameDrainValue: 10,
        // Resource refilled per second while not breathing continuous flame.
        flameFillSpeed: 0,
        // Seconds the flame meter stays empty before it begins refilling.
        flameEmptyDuration: 3,
        // Fireball hit uses point-vs-rectangle with this extra radius.
        ...
        // Continuous flame uses one simplified oriented hitbox extending from the mouth.
        flameHitboxLength: 9,
        flameHitboxWidth: 2.4,
        flameHitboxForwardOffset: 0.8,
        flameSurfaceEpsilon: 0.35,
        // Player-only fire can clamp its rendered stream to the first static-terrain hit.
        clipFlameToStaticPolygons: true,
        // If the mouth/spawn point starts inside a collision polygon, do not emit sustained
        // flame or launch a fireball out through the terrain.
        blockFireInsideStaticPolygons: true,
        debugRenderFlameTerrainCollision: false,
        // Keep fireball impacts gameplay-clean by consuming the projectile on first hit.
        despawnFireballOnHit: true
    },
    PERFORMANCE: {
        enabled: true,
        slowDeviceDetection: {
        ...
        qualityProfiles: {
            ...
            low: {
                ...
                dragonFire: {
                    terrainChecksEnabled: false,
                    flameRateMultiplier: 1,
                    emberRateMultiplier: 0.45,
                    smokeRateMultiplier: 0.4,
                    fireballTrailRateMultiplier: 0.35,
                    fireballImpactParticleMultiplier: 0.6,
    ...
    // "Dragon Fury" ultimate — an Inferno Shockwave. Charge builds while breathing flame
    // (plus a slow passive trickle); once full, KeyR (or the Fury button) unleashes a radial
    ...
    REWARDED_FLAME_BOOST: {
        // Seconds of flame permission after watching a rewarded video.
        durationSeconds: 120,
        // Number of times the flame meter must be fully drained before the button appears.
        unlockDrainCount: 1
    },
    ...
    // Dragon skin definitions — add new skins here, nowhere else.
    // nameKey: i18n key; texture: gameplay dragon texture;
    ...
    dragonSkins: [
        {
            ...
            texture: './gfx/textures/dragon/dragon_texture.webp',
            buttonTexture: './gfx/UI/dragon_texture.webp',
            price: 0,
        ...
        },
        {
            id: 'earth',
            nameKey: 'skins.earth',
            texture: './gfx/textures/dragon/dragon_texture1.webp',
            buttonTexture: './gfx/UI/dragon_texture1.webp',
            price: 0,
            unlockByAd: true
        },
        {
            id: 'ice',
            nameKey: 'skins.ice',
            texture: './gfx/textures/dragon/dragon_texture2.webp',
            buttonTexture: './gfx/UI/dragon_texture2.webp',
            price: 100
        },
        {
            id: 'lava',
            nameKey: 'skins.lava',
            texture: './gfx/textures/dragon/dragon_texture3.webp',
            buttonTexture: './gfx/UI/dragon_texture3.webp',
            price: 200
        },
        {
            id: 'forest',
            nameKey: 'skins.forest',
            texture: './gfx/textures/dragon/dragon_texture4.webp',
            buttonTexture: './gfx/UI/dragon_texture4.webp',
            price: 500
        },
        {
            id: 'shadow',
            nameKey: 'skins.shadow',
            texture: './gfx/textures/dragon/dragon_texture5.webp',
            buttonTexture: './gfx/UI/dragon_texture5.webp',
            price: 700
        },
        {
            id: 'gold',
            nameKey: 'skins.gold',
            texture: './gfx/textures/dragon/dragon_texture6.webp',
            buttonTexture: './gfx/UI/dragon_texture6.webp',
            price: 1000
        }
    ],
    DRAGON_ENERGY_BOOST: {
    ...
    DRAGON_HEALTH: {
        // Dragon health resource. 0 means dead / game-over-ready.
        maxHealthValue: 250,
        ...
        // from applying stacked damage if several overlap the dragon in the same instant.
    ...
    DRAGON_HIT_PUSH: {
        ...
        // without letting heavy hits shove the dragon through collision.
    ...
    DRAGON_HIT_IMPACT: {
        dragonHitImpactScale: 2.5,
        dragonHitImpactDuration: 0.3,
        dragonHitImpactParticleCount: 14,
        // Used only when the projectile does not provide an exact world hit position.
        dragonHitImpactFallbackOffset: 0.9
    },
    DRAGON_HIT_FLASH: {
        hitFlashColor: 0xffffff,
        // MeshBasicMaterial has no emissive channel and the dragon base color is white, so a
    ...
    DRAGON_WATER: {
        ...
        // Higher = more direct steering; the dragon redirects its momentum faster.
        ...
        // How much faster the surface dragon brakes compared to its acceleration rate when pressing the opposite direction.
        waterSurfaceBrakeMultiplier: 2,
        // Distance below the dragon centre to snap to the water surface when idling at the top.
        ...
        // How far below the water surface (world units) before the dragon tilts toward its
        ...
        // Base animation playback speed for swim_idle / swim_idle_up when the dragon is stationary.
    ...
    LEVEL_OBJECTS: {
        ...
        gravity: 52,
        // Matter.js is used only for runtime LevelObject physics. Dragon movement/collision
    ...
    LEVEL_OBJECT_TYPES: {
        ...
        bossdragon: {
            behavior: 'bossdragon',
            modelPath: './gfx/mesh/dragon/bossdragon.glb',
            texturePath: './gfx/textures/dragon/bossdragon_texture.webp',
            pickupable: false,
            draggable: false,
            maxHealth: 3000,
            showHealthBar: false,
            ...
            bossFire: {
                ...
                fireballRange: 60,
                flameRange: 25,
                fireballCooldown: 1.5,
                flameBurstDuration: 6.0,
                flameCooldown: 2.0,
                maxAimAngleUp: 90,
                maxAimAngleDown: 90,
                fireballDamage: 20,
                flameDamagePerSecond: 15,
                fireballSpeed: 100,
                mouthOpenWhileFiring: true,
                debug: false,
            }
        },
        car: {
      ...
      etype: {
        ...
        suit: {
            ...
            walkingBehavior: {
                ...
                // stand idle until the dragon is almost on top of them.
                dragonReactDistance: 15,
                walkActivationRange: 150,
                aiActivationRange: 150,
                moveAwayFromDragon: true,
                // Males should already flee as soon as the dragon gets close enough, even if
                // the stricter face-to-face threat check would not have triggered yet.
                fleeOnDragonProximity: true,
                canWalkSlope: true,
...
//            wreckedBlendMeshes: ['groundsam'],
        ...
        plane: {
            ...
            flyAI: {
                movementType: 'plane',
                // 'patrol' = fly between random points, 'flee' = fly away from dragon when close
                behavior: 'flee',
                ...
                arriveThreshold: 6,
                // World-unit radius within which the dragon triggers flee behaviour.
                fleeRange: 25,
                // Flee target is placed this many units away from the dragon (should be > fleeRange).
                fleeDistance: 30,
        ...
        fighterjet: {
            layerZOffset: 6,
            modelPath: './gfx/mesh/vehicles/fighterjet.glb',
            texturePath: './gfx/textures/vehicles/vehicles.webp',
            // Routes to FighterJetObject which extends PlaneObject with attack behavior.
            behavior: 'fighterjet',
            pickupable: false,
            draggable: false,
            respawn: true,
            ...
            flyAI: {
                movementType: 'plane',
                // 'attack' = pursue dragon and shoot; 'patrol' = default wandering
                behavior: 'attack',
                // Cruise speed during patrol.
                moveSpeed: 8,
                moveUpSpeed: 7,
                moveDownSpeed: 10,
                // Multiplier applied to all three speeds (move/up/down) when in attack mode.
                attackSpeedMultiplier: 3,
                arriveThreshold: 6,
                // Enter attack mode when dragon is within this range.
                dragonDetectRange: 40,
                // Fire bullets when dragon is within this range.
                dragonAttackRange: 28,
                // Return to patrol when dragon is farther than this (hysteresis).
                dragonLoseRange: 55,
                // Plane turning / banking
                planeTurnRate: 1.5,
                planeRollSpeed: 4,
                // Acceleration toward target speed (units/s²).
                speedIncrease: 8,
                // Terrain avoidance look-ahead and steering strength.
                terrainAvoidanceLookAhead: 8,
                terrainAvoidanceStrength: 2.0,
                // Max attempts finding a safe patrol target before falling back to zone center.
                maxSafeTargetAttempts: 20,
                // No zone restriction by default; set via Tiled object property to constrain.
                zoneId: 'flyZone',                
                //zoneId: null,
                debugLogging: false
            },
            // Bullet weapon — reuses the TankObject/ground-turret bullet pool and damage pipeline.
            weapon: {
                enabled: true,
                // Distance within which the fighter jet will attempt to fire.
                fireRange: 28,
                // Seconds between shots.
                fireCooldown: 0.1,
                bulletSpeed: 40,
                bulletDamageToDragon: 2,
                bulletLifetime: 3,
                bulletScale: 0.1,
                bulletHitRadius: 0.4,
                bulletTexturePath: './gfx/levels/bullet.webp',
                // Aim slightly ahead of the dragon based on its velocity.
                aimPrediction: true,
                aimPredictionStrength: 0.5,
                // Maximum angle (degrees) between facing direction and dragon before shooting.
                maxFireAngle: 25
            },
            collisionRect: {
                width: 6,
        ...
        catapult: {
            ...
            catapult: {
                ...
                // Pull mechanics.
                maxPullDistance: 10,
                // Grab activation: dragon must be within this distance of basket while loaded.
