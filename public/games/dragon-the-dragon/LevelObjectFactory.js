...
import { BossDragonObject } from './BossDragonObject.js';
...
import { FighterJetObject } from './FighterJetObject.js';
...
export class LevelObjectFactory {
    ...
    createLevelObject(type, options = {}) {
        ...
        if (normalizedType === 'bossdragon') {
            return new BossDragonObject(commonOptions);
        }
        ...
        if (normalizedType === 'fighterjet' || mergedConfig.behavior === 'fighterjet') {
            return new FighterJetObject(commonOptions);
        }
