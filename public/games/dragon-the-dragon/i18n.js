const STORAGE_KEY = 'dragonLanguage';
...
const LOCALES = {
    en: {
        ...
        loading_preview_label: 'Loading dragon',
        loading_preview_ready: 'Dragon ready',
        ...
        mission_destroy_boss_title: 'HIDDEN MISSION',
        mission_destroy_boss_description: 'Destroy the boss dragon!',
        ...
        'skins.classic': 'Classic Dragon',
        'skins.earth': 'Earth Dragon',
        'skins.ice': 'Sapphire Dragon',
        'skins.lava': 'Emerald Dragon',
        'skins.forest': 'Seismic Dragon',
        'skins.shadow': 'Blizzard Dragon',
        'skins.gold': 'Phantasy Dragon',
    },
    ...
    nl: {
        ...
        mission_destroy_boss_title: 'VERBORGEN MISSIE',
        mission_destroy_boss_description: 'Vernietig de baasdraak!',
    ...
    es: {
        ...
        mission_destroy_boss_title: 'MISIÓN OCULTA',
        mission_destroy_boss_description: '¡Destruye al dragón jefe!',
    ...
    pt: {
        ...
        mission_destroy_boss_title: 'MISSÃO OCULTA',
        mission_destroy_boss_description: 'Destrua o dragão chefe!',
    ...
    de: {
        ...
        mission_destroy_boss_title: 'GEHEIME MISSION',
        mission_destroy_boss_description: 'Besiege den Bossdrachen!',
    ...
    fr: {
        ...
        loading_preview_label: 'Chargement du dragon',
        loading_preview_ready: 'Dragon prêt',
        ...
        mission_destroy_boss_title: 'MISSION CACHÉE',
        mission_destroy_boss_description: 'Détruisez le dragon boss !',

        mission_shark_title: 'MISSION',
        mission_shark_description: 'Mettez un requin dans le bassin à requins !',

        // Dragon Skin Shop
        'skins.title': 'Skins du Dragon',
        ...
        'skins.classic': 'Dragon Classique',
        'skins.earth': 'Dragon Terrestre',
        'skins.ice': 'Dragon Saphir',
        'skins.lava': 'Dragon Émeraude',
        'skins.forest': 'Dragon Sismique',
        'skins.shadow': 'Dragon Blizzard',
        'skins.gold': 'Dragon Fantastique',
    },
    ...
    tr: {
        ...
        mission_destroy_boss_title: 'GİZLİ GÖREV',
        mission_destroy_boss_description: 'Patron ejderhayı yok et!',
    ...
    ru: {
        ...
        mission_destroy_boss_title: 'СКРЫТАЯ МИССИЯ',
        mission_destroy_boss_description: 'Уничтожь дракона-босса!',
