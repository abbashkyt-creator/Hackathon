...
export const MISSION_LEVELS = {
    level_00: './gfx/levels/level2.json',
...
//        commercialBreak: false,
        ...
        coinReward: 10,
        requireGrounded: true, // Optional: require the dragon to be landed on the ground to start this mission
        // Replay rules: can replay after 5 minutes, up to 3 times total.
        replay: { cooldownSeconds: 300, maxReplays: 3 },
        // Dragon must land and stop in this zone to start the mission.
...
//                        { time: 5, flame: false }
                ...
                },
                {
                    type: 'EventTrack',
                    keyframes: [
                        { time: 4, callback: (ctx) => console.log('[Timeline] Dragon is ready!') }
                    ]
                },
                {
                    type: 'SfxTrack',
        ...
        params: {
            ...
            requiredCount: 1,
            zoneId: 'pedestal',
            actorIds: ['girl1','bossdragon1'] // Optional: additional actors to control in the timeline (beyond the default "dragon" player reference)
        }
    },
            ...
            tracks: [
                ...
                },
                {
                    ...
                    keyframes: [
                        ...
                        { time: 7, sfx: 'dragonLiftoff', volume: 0.8  },
...
//                        { time: 4, flame: true, fireAngle: 10 },
                ...
                },
                {
                    ...
                    keyframes: [
                        ...
                        { time: 1.3, sfx: 'dragonHit', volume: 0.8  },
        ...
        params: {
			actorIds: ['girl1','bossdragon1'], 
			targets: ['bossdragon1'],  // sourceObjectName(s) from Tiled
...
//        cameraPreviewZoom: 6,   // zoom out 80% during the preview pan
    ...
    },
   {
        ...
        // After completing this mission, auto-offer the next one.
        coinReward: 30,
        requireGrounded: false, // Optional: require the dragon to be landed on the ground to start this mission
        // Replay rules: can replay after 5 minutes, up to 3 times total.
        replay: { cooldownSeconds: 300, maxReplays: 3 },
        // Dragon must land and stop in this zone to start the mission.
        //disabledButtons: ['fire', 'speed'],
...
/*
    {
        ...
        type: 'FLY_TO_ZONE',
        title: 'MISSION',
        description: 'Follow the other dragon',
        iconObjectType: 'bossdragon',
        completeDelaySeconds: .2,
        // Optional: Play cinematic sequence before gameplay starts
        // Input is locked during playback, then unlocked for gameplay
