...
export class MissionManager {
    ...
    buildTimelineContextForMission(mission) {
        ...
        const actors = { dragon: this.game?.player };
    ...
    async playMissionTimeline(sequence, lockInput = true) {
        ...
        try {
            ...
            this.game?.setTimelineSkipHandler?.(() => {
                ...
                // already applied the correct final state with dragon-special handling.
    ...
    /**
     * showCancelMissionPopup — shown when the dragon lands in a land area for a
