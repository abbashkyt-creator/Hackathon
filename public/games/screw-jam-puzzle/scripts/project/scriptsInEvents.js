    ...
    FBInstant.payments.purchaseAsync({
        ...
        FBInstant.payments.consumePurchaseAsync(purchase.purchaseToken)
            .then(function () {
				...
				runtime.globalVars.IAP_transactionID = purchase.paymentID
				//console.log(purchase.paymentID);
...
const scriptsInEvents = {
	...
	async Loading_Event247_Act2(runtime, localVars)
	{
	...
	async Loading_Event252_Act1(runtime, localVars)
	{
...
if(boxLevel) runtime.objects.JSON_box.getFirstInstance().setJsonDataCopy(boxLevel)
	...
	async Home_Event1546_Act2(runtime, localVars)
	{
	...
	async Home_Event1731_Act1(runtime, localVars)
	{
...
localVars.Variable1 = getFirstDayOfMonth(timestamp);
	...
	async Home_Event1733_Act1(runtime, localVars)
	{
...
localVars.Variable1 = getLastDayOfMonth(timestamp)
	...
	async Home_Event1735_Act1(runtime, localVars)
	{
	...
	async Home_Event2139_Act1(runtime, localVars)
	{
